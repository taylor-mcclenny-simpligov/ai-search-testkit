"""Author: Taylor M
TM-MVP-1 dual-vector query: embed semantics_text and field_candidates separately, search compressed index, merge scores.

Usage:
  python scripts/experiments/tm_mvp1_query_dual.py --input outputs/experiments/TM-MVP-1/tagged aas-60.json --index simpligov-sgws-compressed --k 5 [--dotenv]

Approach:
  - Load JSON from tm_mvp1_extract output.
...
def main() -> None:
    ap = argparse.ArgumentParser(description="TM-MVP-1 dual-vector query")
